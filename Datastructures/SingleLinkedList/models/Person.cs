...
namespace SingleLinkedList.models
{
    class Person
    {
        ...
        //diese Equals()-Methode muss überschrieben werden
        public override bool Equals(object obj)
        {
            // as versucht obj in den Datentyp Person umzuwandeln
            //  falls es funktioniert folgt eine Instanz von Person wird
            //      an die Equas()-Methode übergeben
            //  falls es nicht funktioniert folgt null wird übergeben
            // ==> es wird keine Exception übergeben
        ...
        public override int GetHashCode()
        {
            ...
            //die 2te Zahl ist ebenfalls eine Primzahl es müssen die gleichen Felder (Firstname, Lastname, Birthdate)
